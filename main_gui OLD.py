...
class LibyanaNPMApp:
    ...
    def _build_ftp_tab(self):
        ...
        ttk.Entry(cfg_frame, textvariable=self.password_var, width=40, show="*").grid(row=3, column=1, sticky=tk.W,
                                                                                      padx=5)
        ...
        ttk.Button(btn_frame, text="📅 Download Specific Date", command=self._prompt_date_download).pack(side=tk.LEFT,
                                                                                                        padx=5)
